...
public class BasePhotoFragment extends Fragment {
    ...
    private void initDate() {
        ...
        // 图片的退出动画监听
        imageView.setTransformOutListener(this::gPreviewActivityTransformOut);
    }
    
    private void gPreviewActivityTransformOut(){
        GPreviewActivity activity = (GPreviewActivity) getActivity();
        if (activity != null)
